...
public class Distance extends AppCompatActivity implements OnMapReadyCallback, Serializable {
...
//                break;
    ...
    public void placeVisited(View view) {
        ...
        if(mDatabase.updateVisit(id,plcaevisit)){
            Toast.makeText(Distance.this, "Place Visited", Toast.LENGTH_SHORT).show();
